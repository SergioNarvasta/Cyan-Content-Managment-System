...
namespace Registro6.Models
{
    public class OrdenCompraImp
    {
       ...
       // [Required(ErrorMessage = "Debe de ingresar Proveedor")]
        [MaxLength(25, ErrorMessage = "El campo no debe de tener mas de 12 caracteres")]
        public String Proveedor { get; set; }

        [Required(ErrorMessage = "Debe de ingresar el Contacto")]
        [MaxLength(25, ErrorMessage = "El campo no debe de tener mas de 15 caracteres")]
        public String Contacto { get; set; }

        [Required(ErrorMessage = "Debe de ingresar Area")]
        [MaxLength(19, ErrorMessage = "El campo no debe de tener mas de 12 caracteres")]
